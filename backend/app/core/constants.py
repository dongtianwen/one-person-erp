...
SUMMARY_TRIGGER_PROJECT_CREATED: str = "project_created"
SUMMARY_TRIGGER_PROJECT_UPDATED: str = "project_updated"
SUMMARY_TRIGGER_WHITELIST: list[str] = [
    ...
    SUMMARY_TRIGGER_PROJECT_CREATED,
    SUMMARY_TRIGGER_PROJECT_UPDATED,
]
